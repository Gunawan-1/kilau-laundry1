<x-guest-layout>
    ...
    <div class="flex flex-col items-center mb-6">
        <!-- Ganti SVG ini dengan file logo Anda jika ada -->
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-2">CleanWave Laundry</h1>
        <p class="text-sm text-gray-500">Masuk untuk mengelola pesanan Anda</p>
    </div>
